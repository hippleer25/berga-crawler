...
class StatsCollector:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        stats["requests_queued"] = self.requests_queued
        stats["requests_successful"] = self.requests_successful
        stats["requests_failed"] = self.requests_failed
        stats["requests_retried"] = self.requests_retried
        stats["items_processed"] = self.items_processed
        stats["urls_seen"] = self.urls_seen
